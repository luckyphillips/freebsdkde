...
INSTALLGNOME()
{
            case $1 in
                    [o]*)
                            pkg install -y nvidia-driver-390* gnome3 gdm xorg xf86-video-intel nvidia-xconfig nvidia-settings bash linux-nvidia-libs-390*
                    ;;
                    *)
                            pkg install -y nvidia-driver gnome3 gdm xorg xf86-video-intel nvidia-xconfig nvidia-settings bash linux-nvidia-libs
                    ;;
            esac
            wait
            nvidia-xconfig 
...
INSTALLKDE()
{
            case $1 in
                    [o]*)
                            pkg install nvidia-driver-390* kde5 sddm xorg xf86-video-intel plasma5-plasma-desktop nvidia-xconfig nvidia-settings bash linux-nvidia-libs-390*
                    ;;
                    *)
                            pkg install -y nvidia-driver kde5 sddm xorg xf86-video-intel plasma5-plasma-desktop nvidia-xconfig nvidia-settings bash linux-nvidia-libs                            
                    ;;
            esac
            wait
            nvidia-xconfig 
...
echo ""
echo "Does your system have an (O)lder graphics card or a (N)ewer card?"
